...
<html>
  ...
  <body>
   		<center>
   			...
   			<form action="${pageContext.request.contextPath }/insertInput.do" method="post" onsubmit="return checkForm()">
   				<table width="" cellspacing="0" border="1">
   					...
   					<tr>
   						...
   						<td>
   							...
   							<a href="${pageContext.request.contextPath }/provider/showInsertProvider.do">添加供应商</a>
   						</td>
   					</tr>
   					<!-- <tr>
   						<td>选择供应时间:</td>
   						<td>
   							<input name="createtime" id="createtime" onclick='popUpCalendar(this,this,"yyyy-mm-dd")' readonly
	   				size="8"/>
   						</td>
   					</tr> -->
   				</table>
