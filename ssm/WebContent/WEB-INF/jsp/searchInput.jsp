...
<html>
  <head>
    ...
    <script type="text/javascript">
        ...
        function groupByPro()
        {
        	...
        	{ */
        		document.forms[0].action="${pageContext.request.contextPath }/selectInByName.do";
  ...
  <body>
   		...
   		<h3><a href="${pageContext.request.contextPath }/selectAll.do">返回主页</a></h3>
   			<form action="${pageContext.request.contextPath }/selectInputByKeyword.do" method="post" onsubmit="return checkForm()">
