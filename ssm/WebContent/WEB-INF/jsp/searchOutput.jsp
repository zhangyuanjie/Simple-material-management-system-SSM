...
<html>
    ...
    <script type="text/javascript">
    	function checkForm()
    	{
    	 ...
    	 function groupByPro()
         {
         	...
         	{ */
         		document.forms[0].action="${pageContext.request.contextPath }/selectOutByName.do";
  ...
  <body>
   		...
   		<h3><a href="${pageContext.request.contextPath }/selectAll.do">返回主页</a></h3>
   			<form action="${pageContext.request.contextPath }/selectOutputByKeyword.do" method="post" onsubmit="return checkForm()">
