...
<html>
  ...
  <body>
   		<center>
   			...
   			<form action="${pageContext.request.contextPath }/insertProduct.do" method="post" onsubmit="return checkForm()">
   				<table width="500" cellspacing="0" border="1">
   					<tr>
   						...
   						<td>
   							...
   							<a href="${pageContext.request.contextPath }/showInsertBigtype.do">添加大类</a>
   						</td>
   					</tr>
   					<tr>
   						<td>选择小类:</td>
   						<td>
   							...
   							<a href="${pageContext.request.contextPath }/showInsertSmalltype.do">添加小类</a>
   						</td>
   					</tr>
   					<tr>
   						<td>产品名称:</td>
