...
<html>
  <head>
    ...
    <script type="text/javascript">
    	...
    	function change(state)
    	{
        	...
        	{
            	window.location.href="${pageContext.request.contextPath }/selectAllInput.do";
            }
        	else if(state == 4)
        	{
            	window.location.href="${pageContext.request.contextPath }/selectAllOutput.do";
            }
        	else
        	{
        		window.location.href="${pageContext.request.contextPath }/showInsertProduct.do";
            }
        }
        ...
        function fun1(flag,id)
        {
        	if(flag == 1)
        	{
        		window.location.href = "selectByIdIn.do?id="+id+"&flag="+flag;
        	}
        	else if(flag == 2)
        	{
        		window.location.href = "selectByIdOut.do?id="+id+"&flag="+flag;
            }
            else
            {
            	window.location.href = "showUpdateProduct.do?id="+id+"&flag="+flag;
            }
        }
       	//通过按钮 设置表单提交的action
        function chaxun2(){
        ...
        function changeTypes(bid){
    		...
    		$.getJSON("${pageContext.request.contextPath }/selectByBid.do?bid="+bid,function(data){
    			//清空下拉列表
    			$("#smalltype").empty();
    			//alert(data);
    			//通过ID来控制第二个下拉列表
  ...
  <body>
  	<center>
	  	<div>
	   		<h1>物料库存管理系统</h1>
	   		<h2><a href="${pageContext.request.contextPath }/showLogin.do">返回登录界面</a></h2>
	   		<h3><font color="red">欢迎你：${admin.name}</h3>
	   		<h2><font color="blue">
	   		...
	   		<table width="900" cellspacing="0" border="1">
	   			<form action="${pageContext.request.contextPath }/selectByKeyword.do" method="post" id="myfrom">
	   				<tr align="center">
	   				 <td colspan="8">
